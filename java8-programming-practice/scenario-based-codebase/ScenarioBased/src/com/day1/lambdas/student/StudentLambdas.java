...
public class StudentLambdas {
	public static void main(String[] args) {
		List<Student> students = Arrays.asList(new Student("Priya", 17, 78, 12), new Student("Aman", 19, 92, 3),
				new Student("Sneha", 16, 45, 89), new Student("Rahul", 20, 88, 7), new Student("Kavya", 18, 65, 34));
		...
		// 4. Sort by rank
		System.out.println("\n4. Sorted by rank:");
		students.stream().sorted(Comparator.comparingInt(s -> s.rank)).forEach(System.out::println);
