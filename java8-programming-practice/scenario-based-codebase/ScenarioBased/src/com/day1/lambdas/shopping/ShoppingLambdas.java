...
public class ShoppingLambdas {
	public static void main(String[] args) {
		List<Product> cart = Arrays.asList(new Product("Laptop", 72000), new Product("Headphones", 2500),
				new Product("Mouse", 450), new Product("Keyboard", 1800), new Product("Monitor", 14500));
		...
		// 2. Sort by price
		System.out.println("\n2. Sorted by price:");
		cart.stream().sorted(Comparator.comparingDouble(p -> p.price)).forEach(System.out::println);
