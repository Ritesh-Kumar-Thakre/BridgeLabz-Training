...
- Understood:
  - Java Full-Stack Roadmap & Maker Plan
  - Problem-Solving Approach using Java
  - Coding Standards & Best Practices
- Reviewed shared materials:
  - Roadmap for Java FS + GenAI Program
...
- 1D arrays
- traversal & iteration
- total / average / max-min problems
...
```
1️⃣ Coffee Counter Chronicles  
2️⃣ Maya’s BMI Fitness Tracker  
```
Concepts Used:
- Scanner input
- Operators
